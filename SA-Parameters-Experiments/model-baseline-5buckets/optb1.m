...
[x, blearnt] = learn_buckets_b1(x0, traindataFM, bgold, likeprob);
blearnt(femaleidx) = bgold(femaleidx);

% testing
thresholds = linspace(0, 0.4, 41);
[maxfscore, bestcm, bestthreshold] = test(testdataFM, blearnt, thresholds, likeprob);
